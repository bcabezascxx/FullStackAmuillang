                                ...
                                <div className="mb-3" key={index}>
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            {ActivarCambiosObservacion && observaciones.id===ObservacionNuevo.observacionId && observaciones ? (
                                ...
                                <div className='col-md-6'>
                                    <div className='card p-4 shadow'>
                                        <form onSubmit={(e) => {
                                            ...
                                            <div className="mb-3">
                                                <label className="form-label">Especialidad del especialista</label>
                                                <select
                                                    className="form-control"
                                                    value={filterEspecialistaCargo.especialidad}
                                                    onChange={(e) => setfilterEspecialistaCargo((prev) => ({ ...prev, especialidad: e.target.value }))}
                                                >
                                                    <option value="">Seleccione una especialidad</option>
                                                    {loadingEspecialistas ? (
                                                    <option>Cargando especialidades...</option>
                                                    ) : (
                                                    [...new Set(dataespecialistas.getEspecialistas.map((especialista) => especialista.cargo))].map((cargo) => (
                                                ...
                                                <select
                                                    className="form-control"
                                                    value={observacionesInput.especialistaId}
                                                    onChange={(e) => setobservacionesInput((prev) => ({ ...prev, especialistaId: e.target.value }))}
                                                >
                                                    <option value="">Seleccione un especialista</option>
                                                    {loadingEspecialistas ? (
                                                    <option>Cargando especialistas...</option>
                                                    ) : (
                                                    dataespecialistas.getEspecialistas
                                                        .filter((especialista) => especialista.cargo === filterEspecialistaCargo.especialidad)
                                                        .map((especialista) => (
